...
import { Activity, BookOpen, Bot, CalendarDays, FolderKanban, Gamepad2, GitBranch, ListTodo, Network, RadioTower, Terminal } from "lucide-react";
...
const nav = [
  ...
  { href: "/agents", label: "Agents", icon: Terminal, index: "11" },
];
